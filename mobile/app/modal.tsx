...
export default function ModalScreen() {
  ...
  return (
    <Box flex={1} bg={useColorModeValue('coolGray.50', 'black')} p={4}>
      <VStack space={6} mt={2}>
        <VStack space={1} px={2}>
              ...
              >
                <HStack justifyContent="space-between" alignItems="center">
                  <HStack space={4} alignItems="center">
                    ...
                    <VStack>
                      <Text fontSize="md" fontWeight="bold" color="error.600">Painel Admin</Text>
                      <Text fontSize="xs" color="error.500">Gerenciamento do sistema</Text>
                    </VStack>
                  </HStack>
                  <Icon as={<MaterialIcons name="chevron-right" />} size={5} color="error.600" />
                </HStack>
              </Pressable>
            </>
          )}
